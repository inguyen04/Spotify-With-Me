  ...
  return (
    <>
      <div class="loginpage">
        ...
        <h1 class="title-1">CODA</h1>
        <h1 class="title">
          Experience Your Music<br></br>
          Like Never Before
        </h1>
        <p class="description">
          Come and connect with your friends while listening to music you love.
        </p>
        ...
        <div class="icons">
          <div class="icon-1">
            <p>
              Rate each song on a five-star scale<br></br>and share your
              reaction
            </p>
          ...
          <div class="icon-2">
            <p>
              Write and share reviews<br></br>with friends you follow
            </p>
            <img src={reviewLogo} class="logo-2" alt="Review logo" />
          </div>
          <div class="icon-3">
            <p>
              Listen to new<br></br>recommended songs
            </p>
