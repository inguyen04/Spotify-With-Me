  ...
  return (
    <>
      <div class="loginpage">
        ...
        <div class="icons">
          <div class="icon-1">
            <p>Rate each song on a five-star scale to record and share your reaction</p>
          </div>
          <div class="icon-2">
            <p>Write and share reviews with friends you follow</p>
          </div>
          <div class="icon-3">
            <p>Listen to new recommended songs</p>
          </div>
        </div>
      </div>
    </>
